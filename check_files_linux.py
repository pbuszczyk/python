...
last_year = 0
total_no_of_files = 0
text_file = open("./share_names_linux.txt", "r")
dir_in_consideration = ''
atime = 0
total_percentage = 0.0

#Directory for NFS mount
mnt_dir = "/nfsfilescheckdir"

#Create the directory for NFS mount
subprocess.call(["sudo","mkdir",mnt_dir])
...
for line in text_file:
  ...
  if(1 == 1):
    ...
    #Mount the NFS
    subprocess.call(["sudo","mount","-t","nfs",dir_in_consideration.strip(),mnt_dir])
